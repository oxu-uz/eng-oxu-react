    ...
    return (
        <div className="bg-gray-50">
            ...
            <section className="page-heading-content mb-5" style={{height: "175px"}} data-cid="714">
                <img className="bg-image bg-orange-800" src="/P1007495.MP4_snapshot_00.03.671.jpg"
            ...
            <div className="flex gap-10 mb-5 px-10">
                <div>
                    {/* Purpose Section */}
                        ...
                        >
                            <div className=" mb-8">
                                ...
                                <p className="text-lg text-gray-600 mt-4">
                                    ...
                                    creativity,
                                    cultural exchange, and personal expression. The committee organizes a range of
                                    cultural
                                    events and activities, including art exhibitions, music performances, dance shows,
                                    and
                                    theater productions. These activities serve as platforms for students to explore
                                    their
                                    artistic talents, appreciate diverse cultures, and contribute to a vibrant campus
                                    life
                                    that celebrates inclusivity and unity.
                                </p>
                            </div>
                        </motion.div>
                    </section>
                    ...
                    <section className="container mx-auto px-5 py-10 bg-gray-100 rounded-md">
                        ...
                        >
                            ...
                            <ul className="list-disc pl-5 text-gray-600 space-y-4">
                                <li><strong>Organizing Cultural Events and Festivals:</strong> Plan and execute
                                    campus-wide
                                    events like cultural festivals, music performances, dance shows, and art exhibitions
                                    to
                                    showcase students’ talents and foster cultural appreciation.
                                </li>
                                <li><strong>Promoting Cultural Exchange:</strong> Encourage students to participate in
                                    cultural exchange programs, where they can learn from different cultures and broaden
                                    their global perspectives.
                                </li>
                                <li><strong>Supporting Artistic Talent:</strong> Provide platforms for students to
                                    express
                                    themselves creatively through art, music, dance, drama, and literature.
                                </li>
                                <li><strong>Collaborating with External Artists and Institutions:</strong> Bring
                                    external
                                    performers, artists, and cultural institutions to campus, enhancing the cultural
                                    exposure of students and promoting cross-cultural engagement.
                                </li>
                                <li><strong>Enhancing Student Engagement:</strong> Ensure active student participation
                                    in
                                    cultural activities by encouraging inclusivity and creating a welcoming environment
                                    for
