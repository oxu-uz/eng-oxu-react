        ...
        <Layout className="bg-[#eeeff4]" style={{minHeight: '100vh'}}>
            <nav className="bg-[#012152] py-3 text-white">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        className="top-nav-sup bg-[#012152] absolute right-0 lg:top-0 bottom-0 divide-x divide-[hsla(0,0%,100%,.15)] flex h-max z-10">
                        <a target="_blank" href="https://library.oxu.uz"
                           className="lg:text-sm text-xs p-3 lg:px-4 px-2 cursor-pointer transition-colors top-nav-sup-link">Library</a>
                        <Link
                            to="news"
                            smooth={true}
                            duration={1000}
                        ...
                        <a href="https://int.vacancy.oxu.uz/" target="_blank"
                           className="lg:text-sm text-xs p-3 lg:px-4 px-2 cursor-pointer transition-colors top-nav-sup-link">Career
                            @ OXU</a>
                        <a href="https://aiu.uz/international-form" target="_blank"
                           className="lg:text-sm text-xs p-3 lg:px-4 px-2 cursor-pointer transition-colors top-nav-sup-link">Apply
                            Now</a>
                    </div>

                    <div className="container mx-auto flex flex-row items-center justify-between md:justify-between">
                        {/* Блок 1 */}
                            ...
                            <div className="flex items-center  divide-x divide-[hsla(0,0%,100%,.15)] ">
                                <a data-v-4b8a97f0="" target="_blank"
                                   href="https://www.facebook.com/share/1UaPBeZp76/?mibextid=wwXIfr">
                                    <i data-v-4b8a97f0="">
                                        <svg className="mx-1" data-v-4b8a97f0="" width="26" height="26"
                                             viewBox="0 0 32 32"
                                ...
                                <a data-v-4b8a97f0="" target="_blank" href="https://www.instagram.com/aiu.uzb/">
                                    <i data-v-4b8a97f0="">
                                        <svg className="mx-1" data-v-4b8a97f0="" width="26" height="26"
                                ...
                                <a data-v-4b8a97f0="" target="_blank" href="https://t.me/AzMU_UZ">
                                    <i data-v-4b8a97f0="">
                                        <svg className="mx-1" data-v-4b8a97f0="" width="26" height="26"
                                             viewBox="0 0 32 32" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
