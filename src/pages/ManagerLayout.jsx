...
import { MenuUnfoldOutlined, MenuFoldOutlined, DashboardOutlined, LogoutOutlined, UserOutlined, FileTextOutlined } from '@ant-design/icons';
...
const ManagerLayout = () => {
  ...
  return (
    <Layout className="bg-[#eeeff4]" style={{ minHeight: '100vh' }}>
              <nav className="bg-gradient-to-r from-[#092076] to-[#0a37b3] border-b border-[hsla(0,0%,100%,.1)] py-2 text-white">
