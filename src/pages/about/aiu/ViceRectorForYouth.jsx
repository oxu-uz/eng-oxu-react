            ...
            <section className="page-heading-content mb-5" data-cid="714">
                ...
                <div className="heading-content">
                    <div className="container mx-auto px-5 title">
                        <h1 className="text-2xl md:text-4xl font-bold">FIRST VICE-RECTOR FOR YOUTH POLICY AND
                            RECREATIONAL AND EDUCATIONAL AFFAIRS</h1>
                    </div>
                    <div className="breadcrumb">
                        <div className="container mx-auto">
                            <ul className="flex flex-wrap items-center text-sm">
                                ...
                                <li>
                                    <a className="nav-link" href="/about/aiu/vice-rector/youth">
                                        FIRST VICE-RECTOR FOR YOUTH POLICY AND RECREATIONAL AND EDUCATIONAL AFFAIRS
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div>
                    <div className="flex flex-col md:flex-row items-center gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-gray-800 font-medium">First vice-rector for youth policy and recreational
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Student</span> at Bukhara Engineering and Technology Institute (2011-2015)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Master's student</span> at Tashkent State Pedagogical University (2015-2017)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Network administrator</span> of the Information Technology Center of Bukhara State Medical Institute (September-December 2017)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">PhD student</span> at Bukhara Engineering and Technology Institute (2018-2020)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Assistant</span> at the Department of "Innovative and Information Technologies in Medicine, Biophysics" of Bukhara State Medical Institute (2018-2022)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Associate Professor</span> at the Department of "Innovative and Information Technologies in Medicine, Biophysics" of Bukhara State Medical Institute (2022-2024)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Associate Professor</span> of the Department of "General Technical Sciences" of Asian International University, on a reciprocal basis (2022-2023)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Dean</span> of the Faculty of "Social Sciences and Technology" of Asian International University (January-August 2024)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">First Vice-Rector</span> for Spiritual and Educational Affairs, Department of Youth Policy (August 2024 - present)
                                </p>
                            </div>
                        </div>
                    </div>
...
export default ViceRectorForYouth;
