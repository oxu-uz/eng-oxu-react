...
const ViceRectorAcademic = () => {
    ...
    const navItems = [
        ...
        { label: "First vice-rector for youth policy and recreational and educational affairs", path: "/about/aiu/vice-rector/youth" },
            ...
            <section className="page-heading-content mb-5" data-cid="714">
                ...
                <div className="heading-content">
                    <div className="container mx-auto px-5 title">
                        <h1 className="text-2xl md:text-4xl font-bold">VICE RECTOR FOR ACADEMIC AFFAIRS</h1>
                    </div>
                    <div className="breadcrumb">
                        <div className="container mx-auto">
                            <ul className="flex flex-wrap items-center text-sm">
                                ...
                                <li>
                                    <a className="nav-link" href="/about/aiu/vice-rector/academic">
            ...
            <div className="container mx-auto flex flex-col md:flex-row gap-5 px-5 mb-10">
                <div>
                    <div className="flex flex-col md:flex-row items-center gap-5">
                        <img src="/IMG_9901.jpg" className="h-[300px] object-cover  w-[224px]"/>
                        <div>
                            <h6 className="text-[#012152]">Nurullaev Mirolim Nasirovich</h6>
                            <div className="line"></div>
                            <p className="text-gray-800 font-medium">Vice Rector for academic affairs</p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara Medical Institute</span> (Medical) (2011-2017)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara State University</span> (Chemistry) (2017-2020)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara State University</span> (Master's) (2020-2022)
                                </p>
                            </div>
                        </div>
                    </div>
...
export default ViceRectorAcademic;
