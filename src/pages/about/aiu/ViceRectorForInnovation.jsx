            ...
            <section className="page-heading-content mb-5" data-cid="714">
                ...
                <div className="heading-content">
                    <div className="container mx-auto px-5 title">
                        <h1 className="text-2xl md:text-4xl font-bold">VICE-RECTOR FOR SCIENTIFIC AFFAIRS AND
                            INNOVATIONS</h1>
                    </div>
            ...
            <div className="container mx-auto flex flex-col md:flex-row gap-5 px-5 mb-10">
                <div>
                    <div className="flex flex-col md:flex-row items-center gap-5">
                        <img src="/6644 (1).jpg" className="h-[300px] object-cover  w-[224px]"/>
                        <div>
                            <h6 className="text-[#012152]">Ikramov Amirbek Aminovich</h6>
                            <div className="line"></div>
                            <p className="text-gray-800 font-medium">Vice Rector for scientific affairs and
                                innovations</p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span
                                        className="font-semibold">Doctor of Philosophy (PhD) in Pedagogical Sciences</span>,
                                    Associate Professor
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara State University</span> (Physical Education)
                                    (2002-2006)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara State University</span> (Economics)
                                    (2006-2009)
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start">
                            ...
                            <div>
                                <p className="text-gray-700">
                                    <span className="font-semibold">Bukhara State University</span> (Master's) (2010 -
                                    2012)
                                </p>
                            </div>
                        </div>
...
export default ViceRectorForInnovation;
