...
const StructureOfUniversity = () => {
    ...
    const leadershipTeam = [
        {
            id: 1,
            name: "Nurullaev Mirolim Nasirovich",
            image:"/structureUni/IMG_9901-fotor-2025050416949.png",
        ...
        {
            id: 2,
            name: "Davronova Shakhlo Farmonovna",
            image:"/structureUni/024-fotor-2025050416719.png",
            position: "First vice-rector for youth policy and recreational and educational affairs",
            work_schedule: "Every day from 09.00 to 18.00",
            address: "Bukhara city, \"Yangiabad MFY\", Gijduvan street, house 74.",
            educational_info: [
        ...
        {
            id: 3,
            name: "Ikramov Amirbek Aminovich",
            image:"/structureUni/6644 (1)-fotor-202505041698.png",
            position: "Vice Rector for scientific affairs and innovations",
            work_schedule: "Every day from 09.00 to 18.00",
            address: "Bukhara city, \"Yangiabad MFY\", Gijduvan street, house 74.",
            educational_info: [
                    ...
                    >
                        {selectedMember && (
                            <div style={{padding: 20}}>
                                <Row gutter={24}>
                                    <Col span={8}>
                                        <img src={selectedMember.image} className="h-[150px] object-cover rounded-full w-[150px]"/>
                                    </Col>
                                    <Col span={16}>
...
export default StructureOfUniversity;