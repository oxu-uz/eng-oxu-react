...
const Layout = () => {
    return (
        <div>
            ...
            {/*    </a>*/}
            {/*</div>*/}
            {/*<nav className="bg-[#012152] px-20 flex items-center justify-end  h-[56px]">*/}
            {/*    <div className="flex items-center gap-2"><a data-v-4b8a97f0="" target="_blank"*/}
            {/*                               href="https://www.facebook.com/tsueuzofficial"><i data-v-4b8a97f0="">*/}
            {/*        <svg data-v-4b8a97f0="" width="26" height="26" viewBox="0 0 32 32" fill="none"*/}
            ...
            {/*                  fill="white"></path>*/}
            {/*        </svg>*/}
            {/*    </i></a> <a data-v-4b8a97f0="" target="_blank" href="https://t.me/tsueuzofficial"><i data-v-4b8a97f0="">*/}
            {/*        <svg data-v-4b8a97f0="" width="26" height="26" viewBox="0 0 32 32" fill="none"*/}
            {/*             xmlns="http://www.w3.org/2000/svg">*/}
            {/*            <path data-v-4b8a97f0=""*/}
            ...
            {/*        <svg data-v-4b8a97f0="" width="24" height="24" viewBox="0 0 24 24" fill="none"*/}
            {/*             xmlns="http://www.w3.org/2000/svg">*/}
            {/*            <path data-v-4b8a97f0=""*/}
