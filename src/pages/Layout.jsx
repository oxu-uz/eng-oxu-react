...
const Layout = () => {
    ...
    return (
        <div>
            <nav className="bg-[#012152] lg:block hidden border-b border-[hsla(0,0%,100%,.1)] py-2 text-white">
                <div className="flex flex-row items-center justify-between px-4">
                    ...
                    {/* Блок 3 */}
                    <div className="flex flex-col items-center text-center">
                        <span onClick={handleContactClick} className="text-base cursor-pointer font-semibold leading-tight">Contacts</span>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div class="flex items-center  divide-x divide-[hsla(0,0%,100%,.15)] ">
                            <a data-v-4b8a97f0="" target="_blank" href="https://www.facebook.com/share/1UaPBeZp76/?mibextid=wwXIfr">
                                <i data-v-4b8a97f0="">
                            ...
                            <a data-v-4b8a97f0="" target="_blank" href="https://youtube.com/@asiaintrntnluniversityofficial?si=XChd7BLqJXx6ODO-" class="pl-1">
