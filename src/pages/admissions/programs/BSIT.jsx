        ...
        <div className="bg-white">
            ...
            <section className="relative h-64 md:h-96 overflow-hidden mb-5">
                <img
                    ...
                    src="/bsit.jpg"
                    alt="Tech team collaborating on project"
                />
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        ...
                        >
                            <ul className="flex flex-wrap items-center text-sm md:text-base text-white/80">
                                ...
                                <li>
                                    <a className="text-white font-medium" href="/admissions/bsit">
                                        BSIT
                                    </a>
                                </li>
                            </ul>
                ...
                <div className="w-full lg:w-1/2 order-2 lg:order-1 text-gray-800 space-y-8">
                    ...
                    >
                        <p className="text-base md:text-lg font-medium leading-relaxed">
                            The BSIT program prepares students for careers in the dynamic tech industry, with the option to transfer to the U.S. for advanced training at WUST. This program combines practical IT skills with critical thinking and innovation.
                        </p>
                    </motion.section>
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            {[
                                {
                                    title: "U.S.-Aligned Curriculum",
                                    content: "Comprehensive coursework including cybersecurity, AI, and software engineering"
                                },
                                {
                                    title: "Hands-On Learning",
                                    content: "Emphasis on hands-on labs, project-based learning, and real-time collaboration"
                                },
                                {
                                    title: "Industry Preparation",
                                    content: "Preparation for global tech certifications and job-readiness"
                                },
                                {
                                    title: "International Pathway",
                                    content: "Option to transfer to WUST in the U.S. for advanced training"
                                }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}
                    ...
                    >
                        ...
                        <div className="bg-gray-50 p-4 md:p-5 rounded-lg shadow-sm">
                            <p className="text-sm md:text-base">
                                Graduates are well-prepared for roles in software development, IT project management, systems analysis, and data science — with international job prospects enhanced by U.S.-based education.
                            </p>
                        </div>
                    </motion.section>
                    ...
                    >
                        ...
                        <div className="bg-gray-50 p-4 md:p-5 rounded-lg shadow-sm">
                            <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
                                ...
                                <li>Interest in technology and problem-solving</li>
                    ...
                    >
                        ...
                        <div className="bg-gray-50 p-4 md:p-5 rounded-lg shadow-sm">
                            <p className="text-sm md:text-base mb-4">
                                Ready to launch your career in technology? Our admissions team will guide you through the application process to start your journey in the dynamic world of IT.
                            </p>
                            <button
                    ...
                    >
                        ...
                        <div className="bg-gray-50 p-4 md:p-5 rounded-lg shadow-sm">
                            <p className="text-sm md:text-base">
                                At AIU, we prepare you for success in the rapidly evolving tech industry. With our partnership with WUST in the USA, you'll gain cutting-edge skills and global perspective needed to excel in today's digital world.
                            </p>
                        </div>
                    </motion.section>
                </div>
