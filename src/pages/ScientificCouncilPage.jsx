...
const ScientificCouncilPage = () => {
    ...
    return (
        ...
        >
          <img
            className="bg-image bg-green-900 w-full h-full object-cover"
            src="/P1007495.MP4_snapshot_00.03.671.jpg"
            alt="Council for the Scientific Activities and Research"
          />
          <div className="heading-content absolute inset-0 flex flex-col justify-center">
            <div className="container mx-auto px-5 title">
              <h1 className="text-white text-4xl font-bold">
                Council for the Scientific Activities and Research
              </h1>
            </div>
        ...
        <div className="flex flex-col md:flex-row mb-5 gap-10 px-5 md:px-10">
            ...
            <section className="container mx-auto px-5 py-10 bg-gray-100 rounded-md">
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-4">
                  <li>
                    <strong>Facilitating Research Opportunities:</strong> Encourage and assist students
                    in undertaking research projects by connecting them with faculty mentors and
                    academic resources.
                  </li>
                  <li>
                    <strong>Organizing Workshops and Seminars:</strong> Conduct training sessions on
                    research methodologies, report writing, and publication ethics to enhance students'
                    research skills and knowledge.
                  </li>
                  <li>
                    <strong>Promoting Research Dissemination:</strong> Support students in publishing
                  ...
                  <li>
                    <strong>Maintaining a Research Repository:</strong> Develop and manage a database of
