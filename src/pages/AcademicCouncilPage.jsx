...
const AcademicCouncilPage = () => {
  ...
  const councilImages = [
    ...
    return (
        ...
        >
          <img
            className="bg-image bg-blue-900 w-full h-full object-cover"
          ...
          <div className="heading-content absolute inset-0 flex flex-col justify-center">
            <div className="container mx-auto px-5 title">
              <h1 className="text-white text-4xl font-bold">
                Council of the Academic Activities
              </h1>
            </div>
        ...
        <div className="flex flex-col md:flex-row mb-5 w-full gap-10 px-5 md:px-10">
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-600 mt-4">
                    The purpose of an Academic Co-Curricular Committee in conducting activities like quizzes,
                    presentations, Olympiads, science exhibitions, and similar events is to complement classroom
                    learning by fostering critical thinking, creativity, and practical application of knowledge.
                    These activities provide students with opportunities to explore subjects beyond the syllabus,
                    develop essential life skills such as teamwork, communication, and problem-solving, and
                    cultivate a competitive yet collaborative spirit. By engaging in these events, students gain
                    exposure to diverse perspectives, enhance their intellectual curiosity, and build confidence,
                    preparing them for academic and professional challenges in a dynamic world.
                  </p>
                </div>
              </motion.div>
            </section>
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-600 mt-4">
                    ...
                    and evaluating various academic activities and events. Below are the key roles and
                    responsibilities:
                  </p>
                </div>
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-4">
                  <li>
                    <strong>Organizing and Promoting Activities:</strong> Plan and coordinate academic
                    and co-curricular events such as quizzes, debates, Olympiads, science exhibitions, and
                    seminars to enrich students' learning experiences as mentioned in the academic calendar.
                  </li>
                  <li>
                    <strong>Encouraging Student Participation:</strong> Motivate and guide students to actively
                    participate in events, ensuring inclusivity and equal opportunities for all.
                  </li>
                  <li>
                    <strong>Collaboration and Resource Management:</strong> Collaborate with faculty, external
                    experts, and resource persons to facilitate workshops, competitions, and other programs,
                    while managing the required logistics and materials.
                  </li>
                  <li>
                    <strong>Evaluation and Feedback:</strong> Assess the effectiveness of activities, gather
                    feedback from participants, and implement improvements for future initiatives to align
                    with the committee’s educational goals.
                  </li>
                </ul>
