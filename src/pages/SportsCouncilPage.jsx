            ...
            <section className="container mx-auto px-5 py-10 bg-gray-100 rounded-md">
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-4">
                  <li>
                    <strong>Organizing Sports Events and Tournaments:</strong> Plan, coordinate, and
                    oversee intra- and inter-collegiate sports competitions to encourage participation and
                    showcase athletic talents.
                  </li>
                  <li>
                    <strong>Promoting Physical Fitness:</strong> Initiate programs, workshops, and
                    activities that emphasize the importance of health, fitness, and an active lifestyle
                    among students.
                  </li>
                  <li>
                    <strong>Supporting Team Development:</strong> Facilitate the formation and training
                    of sports teams, providing resources, coaching support, and practice schedules to
                    enhance performance.
                  </li>
                  <li>
                    <strong>Managing Sports Facilities and Resources:</strong> Ensure the proper
