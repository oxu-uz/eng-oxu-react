...
const IntForm = () => {
  ...
  const handleFinish = async (values) => {
    ...
    try {
      ...
      const response = await fetch('https://api.yourdomain.com/external_form/store', {
        method: 'POST',
        headers: {
      ...
      <div className='h-full bg-gray-50 pb-10'>
        <div className='mx-auto max-w-7xl'>
          <div className='flex flex-col lg:flex-row justify-center px-6 py-12 gap-8'>
            <div className="w-full lg:w-1/2 flex items-center justify-center overflow-hidden rounded-lg shadow-lg">
              <video
                  id='video'
            ...
            <div className='w-full lg:w-1/2 bg-white p-8 rounded-lg shadow-lg'>
              ...
              >
                ...
                <Form.Item>
                  ...
                  >
                    I agree to the <a className="text-blue-600" href="https://www.lex.uz/acts/4396419" target="_blank" rel="noopener noreferrer">Terms and Conditions</a> and Privacy Policy
                  </Checkbox>
                </Form.Item>
