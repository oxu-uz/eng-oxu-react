...
const ITMediaCouncilPage = () => {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row gap-10 px-5 md:px-10 mb-5">
            ...
            <section className="container mx-auto px-5 py-10 bg-gray-100 rounded-md">
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-4">
                  <li>
                    <strong>Managing Digital Communication:</strong> Oversee the creation and maintenance of social media pages, websites, and other digital platforms to ensure timely updates about events and university news.
                  </li>
                  <li>
                    <strong>Promoting Campus Activities:</strong> Design and create promotional materials, including videos, images, posters, and flyers to highlight student council initiatives, events, and achievements.
                  </li>
                  <li>
                    <strong>Technical Support:</strong> Provide technical assistance for events, such as audio-visual setup, live streaming, and digital presentations, ensuring smooth execution of programs.
                  </li>
                  <li>
                    <strong>Collaboration:</strong> Collaborate with other committees to enhance students’ technical skills in areas like graphic design, video editing, and social media management. Encourage cross-collaboration for more creative and engaging campaigns.
                  </li>
                </ul>
              </motion.div>
            </section>
