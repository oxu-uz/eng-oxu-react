                        ...
                        >
                            <div className="mb-8">
                                ...
                                <ul className="list-disc pl-5 text-gray-600 space-y-4 mt-4">
                                    <li><strong>Foundational Education:</strong> Provides a broad-based education in key scientific disciplines, including biology, chemistry, and environmental science.</li>
                                    <li><strong>Skill Development:</strong> Focuses on developing critical thinking and analytical skills through diverse course offerings and laboratory experiences.</li>
                                    <li><strong>Interdisciplinary Approach:</strong> Integrates various scientific principles to help students understand and tackle complex concepts.</li>
                                    <li><strong>Preparation for Specialization:</strong> Lays the groundwork for students pursuing advanced degrees or careers in fields like science, technology, healthcare, and engineering.</li>
                                    <li><strong>Research and Inquiry:</strong> Encourages engagement in research and hands-on projects, fostering an environment of exploration and innovation.</li>
                                    <li><strong>Practical Application:</strong> Emphasizes real-world problem-solving skills, preparing students to apply their scientific knowledge practically.</li>
                                </ul>
                            </div>
                        </motion.div>
                    </section>
