            ...
            <section className="page-heading-content mb-5" style={{ height: "175px" }}>
                ...
                <div className="heading-content">
                    <div className="container mx-auto px-5 title">
                        <h1 className="text-white text-4xl font-bold">Department of Clinical Sciences</h1>
                    </div>
                    <div className="breadcrumb">
                        <div className="container mx-auto">
                            <ul>
                                ...
                                <li className="sideNav-link">
                                    <span className="nav-link text-white">Department of Clinical Sciences</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        >
                            <div className="mb-8">
                                ...
                                <p className="text-lg text-gray-600 mt-4">
                                    The Department of Clinical Sciences serves as a crucial link between foundational
                                    medical knowledge and real-world healthcare practice. It provides education and
                                    training focused on patient care, emphasizing the application of medical theories
                                    in diagnosing and treating illnesses. Through hands-on clinical experiences and
                                    evidence-based practices, it prepares future healthcare professionals for the
                                    complexities of medical practice and further specialization in various clinical
                                    fields.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="mb-8">
                                ...
                                <ul className="list-disc pl-5 text-gray-600 space-y-4 mt-4">
                                    <li><strong>Clinical Education:</strong> Focuses on the practical aspects of
                                        healthcare, bridging the gap between basic medical sciences and clinical
                                        practice.
                                    </li>
                                    <li><strong>Patient-Centered Training:</strong> Emphasizes the application of
                                        medical knowledge in patient care, including diagnosis, treatment, and
                                        prevention of diseases.
                                    </li>
                                    <li><strong>Interdisciplinary Collaboration:</strong> Promotes teamwork among
                                        different healthcare specialties to provide comprehensive patient care.
                                    </li>
                                    <li><strong>Hands-On Experience:</strong> Provides opportunities for clinical
                                        rotations and hands-on practice in various medical settings, such as hospitals
                                        and clinics.
                                    </li>
                                    <li><strong>Professional Skills Development:</strong> Develops essential skills
                                        like communication, decision-making, and ethical practice in a clinical setting.
                                    </li>
                                    <li><strong>Research and Evidence-Based Practice:</strong> Encourages students to
                                        engage in clinical research and apply evidence-based methods to improve patient
                                        outcomes.
                                    </li>
                                    <li><strong>Preparation for Internship Training:</strong> Prepares students for
                                        residency programs and further specialization in various medical fields.
                                    </li>
                                </ul>
                            </div>
                        </motion.div>
