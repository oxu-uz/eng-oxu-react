              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-600 mt-4">
                    The Department of Fundamental Medicine is the cornerstone of medical
                    education and research, focusing on the essential sciences that form
                    the basis of medical knowledge and practice. It integrates multiple
                    disciplines to provide a holistic understanding of the human body in
                    health and disease.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="mb-8">
                  ...
                  <ul className="list-disc pl-5 text-gray-600 space-y-4">
                    <li>
                      <strong>Educational Foundation:</strong> Provides foundational
                      coursework for medical students, emphasizing scientific principles
                      critical for clinical training.
                    </li>
                    <li>
                      <strong>Research and Innovation:</strong> Engages in cutting-edge
                      research to advance understanding of diseases and develop medical
                      solutions.
                    </li>
                    <li>
                      <strong>Interdisciplinary Integration:</strong> Combines disciplines
                      like anatomy, physiology, and genetics for a comprehensive approach to
                      education and research.
                    </li>
                    <li>
                      <strong>Clinical Relevance:</strong> Links basic sciences to clinical
                      practices, ensuring students grasp the real-world application of their
                      studies.
                    </li>
                    <li>
                      <strong>Training and Skills Development:</strong> Equips students with
                      critical scientific and technical skills through practical labs and
                      workshops.
                    </li>
                  </ul>
                </div>
