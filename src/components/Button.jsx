...
const Button = React.forwardRef(({ variant, size, block, pill, icon, className, tagName, as, to, href, target, type, onClick, disabled, ...props}, ref) => {
    const compClass = classNames({
        ...
        "text-xxs font-medium leading-5 px-2 tracking-wide": size === "xs" && !icon,
        "text-xs font-medium leading-5 px-3 py-1 tracking-wide": size === "sm" && !icon,
        "text-sm font-medium text-center leading-4.5 px-5 py-2 tracking-wide": size === "rg" && !icon,
        "text-base font-medium leading-4.5 px-6 py-3 tracking-wide": size === "lg" && !icon,
        "text-lg font-medium leading-5 px-8 py-4 tracking-wide": size === "xl" && !icon,
