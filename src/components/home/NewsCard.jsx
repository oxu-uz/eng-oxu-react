...
function NewsCard({ id,image, category, title, className, description }) {
    ...
    return (
        <article className={`flex group cursor-pointer flex-col ${className}`}>
            ...
            <div onClick={handleClick} className="flex flex-col  transition-colors items-start py-2 mt-1 w-full  max-md:pr-5">
