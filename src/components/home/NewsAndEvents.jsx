...
const newsData = [
    { id: 1, image: 'https://cdn.builder.io/api/v1/image/assets/0e60d26ffe404316aa35b6241738714a/d9871df031dd822b2a0766bf3a2647c28b72ed737baeeda88b2ab7d80d3a8517?apiKey=0e60d26ffe404316aa35b6241738714a&', category: 'Academic', title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sodales in turpis eget volutpat' },
    { id: 2, image: 'https://cdn.builder.io/api/v1/image/assets/0e60d26ffe404316aa35b6241738714a/dc33f13cf62ddc9a2e7032565f80e353788c1395af9f2ba66e01f59dfc1dccc7?apiKey=0e60d26ffe404316aa35b6241738714a&', category: 'Academic', title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sodales in turpis eget volutpat' },
    { id: 3, image: 'https://cdn.builder.io/api/v1/image/assets/0e60d26ffe404316aa35b6241738714a/d7034aca5029b520615e9c6981325ad2b917bb357bfaea1c7b69021e6851b6f6?apiKey=0e60d26ffe404316aa35b6241738714a&', category: 'Academic', title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sodales in turpis eget volutpat' },
    { id: 4, image: 'https://cdn.builder.io/api/v1/image/assets/0e60d26ffe404316aa35b6241738714a/34cd8d13aeaa938a0a6a1bc326981ec8719405870fbf13f7ae53b1f02914610e?apiKey=0e60d26ffe404316aa35b6241738714a&', category: 'Academic', title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sodales in turpis eget volutpat' },
];

function NewsAndEvents() {
    return (
        <section className="flex flex-col items-center px-20 pt-14 pb-32 bg-white max-md:px-5 max-md:pb-24">
            <div className="flex flex-col w-full max-w-[1663px] max-md:max-w-full">
                <header className="flex flex-wrap gap-5 justify-start items-center w-full max-md:max-w-full">
                    <h1 className="text-5xl font-extrabold leading-tight text-[#04247B] max-md:text-4xl">
                        News & Events
                    </h1>
                    <button
                ...
                <main className="mt-8 max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-col">
                        ...
                        {newsData.slice(2).map((news) => (
                            <NewsCard key={news.id} {...news} className="w-3/12 max-md:ml-0 max-md:w-full"/>
                        ))}
                    </div>
                </main>
            </div>
