...
const TopNav = () => {
    return (
        <div
            className="top-nav lg:px-10 px-5 overflow-hidden h-[120px] border-b border-[hsla(0,0%,100%,.2)] relative flex justify-between">
            ...
            <div className="top-nav-sup absolute right-0 lg:top-0 bottom-0  divide-x divide-[hsla(0,0%,100%,.15)]  flex h-max z-10">
