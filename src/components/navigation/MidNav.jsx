    ...
    <>
      <div className="top-nav bg-[#012152] lg:px-10 px-5 overflow-hidden p-2 border-b border-[hsla(0,0%,100%,.1)] relative flex justify-between">
        ...
        <div className="bg-[#012152] flex items-center">
          ...
          <a
            href="https://aiu.uz/international-form"
            target="_blank"
            className="lg:text-sm text-xs p-3 lg:px-4 px-2 cursor-pointer transition-colors top-nav-sup-link"
          >
            Apply Now
            ...
            <div className="container mx-auto px-4 flex flex-wrap items-center justify-evenly md:justify-between">
              ...
              <div className="flex flex-col items-center text-center">
                <span
                  ...
                  className="text-sm cursor-pointer font-semibold leading-tight"
                >
                  Contacts
                </span>
                <span className="text-xs hidden opacity-80">
