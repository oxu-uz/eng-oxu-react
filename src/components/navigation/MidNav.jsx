        ...
        return (
            <div>
                ...
                {open && (
                    <div className="ml-4">
                        <a
                            href={getPersonalCabinetPath()}
                            className="block py-3 px-4 text-white hover:bg-[#072799]"
                        >
                            Enter Profile
                        </a>
                        {
            ...
            {mobileMenuOpen && (
                <div className="md:hidden bg-[#012152]">
                    ...
                    <nav className="bg-[#012152] py-3 text-white">
                        <div className="container mx-auto px-4 flex flex-wrap items-center justify-evenly md:justify-between">
                            {/* Блок 1 */}
                            <div className="flex flex-col items-center text-center">
                                <a href="mailto:info@oxu.uz" className="text-sm font-semibold leading-tight">
                                    info@oxu.uz
                                </a>
                                <span className="text-xs hidden opacity-80">Cooperative email</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <span className="text-xs hidden opacity-80">Hotline for applicants</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <span className="text-xs hidden opacity-80">Address and telephone</span>
                            </div>
                    ...
                    {/* Add Personal Cabinet to mobile menu */}
                    <MobilePersonalCabinet />
